      ...
      <div className="relative overflow-hidden rounded-lg border border-purple-500/30 bg-background group">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-3 p-3 sm:p-4">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <ClickableLink href={`/twitch/${playerInfo.username}/setup`} className="group flex-1 sm:flex-none hover-tween relative inline-flex items-center justify-center px-3 sm:px-6 py-2 overflow-hidden font-bold bg-purple-600 rounded-md hover:text-white">
              <span className="mr-2 truncate text-xs sm:text-base">Configurer mon overlay de stream</span>
              <svg className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Button
              ...
              className="p-2 text-gray-500 transition-colors rounded-full hover:bg-card"
              aria-label="Fermer"
            >
