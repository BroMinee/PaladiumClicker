...
export function TwitchLogo() {
  return (
    <div className="relative shrink-0 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-full shadow-[0_0_15px_rgba(147,51,234,0.5)]">
  ...
  return (
    <div className="w-full mx-auto mb-6 animate-in fade-in slide-in-from-top-4 duration-500">
      <div className="relative overflow-hidden rounded-lg border border-purple-500/30 bg-background group">
        <div className="absolute inset-0 bg-linear-to-r from-purple-900/80 via-purple-900/50 z-0 pointer-events-none" />
        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-3 p-3 sm:p-4">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <ClickableLink href={`/twitch/${playerInfo.username}/setup`} className="group flex-1 sm:flex-none transform ease-in-out hover:scale-105 relative inline-flex items-center justify-center px-3 sm:px-6 py-2 overflow-hidden font-bold transition-all duration-300 bg-purple-600 rounded-md hover:text-white">
              <span className="mr-2 truncate text-xs sm:text-base">Configurer mon overlay de stream</span>
              <svg className="w-3 h-3 sm:w-4 sm:h-4 shrink-0 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
