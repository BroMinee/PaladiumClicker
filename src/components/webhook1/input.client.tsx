...
export function ConfirmDeleteModal({ isOpen, onClose, onConfirm, title, desc }: any) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#1a1d24] border-gray-800 text-white sm:max-w-md">
        <DialogHeader>
        ...
        <DialogFooter className="gap-2 sm:gap-0">
          <Button variant="outline" onClick={onClose} className="border-gray-700 hover:bg-gray-800 text-gray-300">
            Annuler
          </Button>
