  ...
  return (
    <>
      <nav className="flex-grow">
        ...
        <CategorieDisplay name={"Classement"}>
          <LinkClient path={constants.moneyRanking}>
            <RiMoneyDollarCircleFill size={24}/>
          </LinkClient>
          <LinkClient path={constants.metiersRanking}>
            <JobIcon/>
          </LinkClient>
          <LinkClient path={constants.bossRanking}>
            <LuSkull size={24}/>
          </LinkClient>
          <LinkClient path={constants.eggHuntRanking}>
            <PiEggCrackBold size={24}/>
          </LinkClient>
          {/*<LinkClient path={constants.eggHuntRanking}>*/}
          {/*  <GiCosmicEgg size={24}/>*/}
          {/*  END*/}
          ...
          <LinkClient path={constants.kothRanking}>
            <GiCrenelCrown size={24}/>
          </LinkClient>
          <LinkClient path={constants.clickerRanking}>
            <TbHandClick size={24}/>
          </LinkClient>
        </CategorieDisplay>
        <CategorieDisplay name={"Statistiques"}>
