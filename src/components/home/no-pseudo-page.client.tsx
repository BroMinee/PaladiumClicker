...
const FEATURES: FeatureItem[] = [
  ...
  { id: "crafts-2", title: constants.links[constants.craftPath].label, desc: "Optimisation des coûts.", icon: <GrOptimize size={20} />, image: "/img/Profile/default.png", href: constants.craftPath },
