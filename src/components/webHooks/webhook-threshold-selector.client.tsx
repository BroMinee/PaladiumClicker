...
import { ThreshConditionSelector } from "@/components/webHooks/admin-shop/webhook-client";
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      <button
        ...
        className="bg-primary px-4 py-2 rounded-lg text-lg font-medium transition hover:bg-primary/70 disabled:bg-card-foreground disabled:cursor-not-allowed"
      >
        -
      </button>
