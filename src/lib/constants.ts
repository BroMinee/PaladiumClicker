...
const startSeason = new Date("2025-07-11");
...
const how_to_xp: HowToXp = {
  "miner": [
    ...
    { type: "Iron Ingot", "action": SMELT, "xp": 8, imgPath: "iron_ingot.webp" },
    { type: "Diamond Ore", "action": BREAK, "xp": 25, imgPath: "diamond_ore.webp" },
    { type: "Gold Ingot", "action": SMELT, "xp": 30, imgPath: "gold_ingot.webp" },
    { type: "Amethyst Ingot", "action": SMELT, "xp": 35, imgPath: "amethyst_ingot.webp" },
    { type: "Iron Particle", "action": OBTAIN_FROM_COBBLEBREAKER, "xp": 2, imgPath: "iron_particle.webp" },
    { type: "Gold Particle", "action": OBTAIN_FROM_COBBLEBREAKER, "xp": 4, imgPath: "gold_particle.webp" },
    { type: "Diamond Particle", "action": OBTAIN_FROM_COBBLEBREAKER, "xp": 8, imgPath: "diamond_particle.webp" },
    { type: "Amethyst Particle", "action": OBTAIN_FROM_COBBLEBREAKER, "xp": 12, imgPath: "amethyst_particle.webp" },
    { type: "Titane Particle", "action": OBTAIN_FROM_COBBLEBREAKER, "xp": 16, imgPath: "titane_particle.webp" },
    { type: "Paladium Particle", "action": OBTAIN_FROM_COBBLEBREAKER, "xp": 20, imgPath: "paladium_particle.webp" },
    { type: "Titane Ingot", "action": SMELT, "xp": 50, imgPath: "titane_ingot.webp" },
    { type: "Cavernous Zombie", "action": KILL, "xp": NaN, imgPath: "cavernous_zombie.webp" },
    { type: "Paladium Ingot", "action": SMELT, "xp": 150, imgPath: "paladium_ingot.webp" },
    { type: "Findium Ore", "action": BREAK, "xp": 110, imgPath: "findium_ore.webp" },
  ...
  "farmer": [
    ...
    { type: "Potatoes", "action": BREAK, "xp": 2, imgPath: "potato.webp" },
    { type: "Carrots", "action": BREAK, "xp": 2.5, imgPath: "carrot.webp" },
    { type: "Melon", "action": BREAK, "xp": 4, imgPath: "melon.webp" },
    { type: "Pumpkin", "action": BREAK, "xp": 5, imgPath: "pumpkin.webp" },
    { type: "Farmer Chicken", "action": KILL, "xp": NaN, imgPath: "farmer_chicken.webp" },
    { type: "Amethyst Ingot", "action": CRUSH, "xp": 3, imgPath: "amethyst_ingot.webp" },
    { type: "Eggplant", "action": BREAK, "xp": 10, imgPath: "eggplant.webp" },
    { type: "Pumpkin Pie", "action": CRAFT, "xp": 4, imgPath: "pumpkin_pie.webp" },
    { type: "Titane Ingot", "action": CRUSH, "xp": 4.5, imgPath: "titane_ingot.webp" },
    { type: "Chervil", "action": BREAK, "xp": 20, imgPath: "chervil.webp" },
    { type: "Paladium Ingot", "action": CRUSH, "xp": 6, imgPath: "paladium_ingot.webp" },
  ...
  "hunter": [
    ...
    { type: "Carp", "action": FISH, "xp": 150, imgPath: "carp.webp" },
    { type: "Bass", "action": FISH, "xp": 225, imgPath: "bass.webp" },
    { type: "Manta Ray", "action": FISH, "xp": 300, imgPath: "manta_ray.webp" },
    { type: "Snail", "action": KILL, "xp": 25, imgPath: "snail.webp" },
    { type: "Red Tuna", "action": FISH, "xp": 450, imgPath: "red_tuna.webp" },
    { type: "Moonfish", "action": FISH, "xp": 550, imgPath: "moonfish.webp" },
    { type: "Exp Fish", "action": FISH, "xp": 750, imgPath: "exp_fish.webp" },
    { type: "Parrot", "action": KILL, "xp": 30, imgPath: "parrot.webp" },
    { type: "Whale", "action": FISH, "xp": 10000, imgPath: "whale.webp" },
    { type: "Kraken", "action": FISH, "xp": 15000, imgPath: "kraken.webp" },
    { type: "Dolphin", "action": KILL, "xp": 35, imgPath: "dolphin.webp" },
    { type: "Mega Creeper", "action": KILL, "xp": NaN, imgPath: "mega_creeper.webp" },
    { type: "Zombie", "action": KILL, "xp": 15, imgPath: "zombie.webp" },
    { type: "Turtle", "action": KILL, "xp": 40, imgPath: "turtle.webp" },
    { type: "Panda", "action": KILL, "xp": 60, imgPath: "panda.webp" },
    { type: "Skeleton", "action": KILL, "xp": 20, imgPath: "skeleton.webp" },
    { type: "Elephant", "action": KILL, "xp": NaN, imgPath: "elephant.webp" },
    { type: "Crab", "action": KILL, "xp": 80, imgPath: "crab.webp" },
    { type: "Spider", "action": KILL, "xp": 8, imgPath: "spider.webp" },
    { type: "Blaze", "action": KILL, "xp": 25, imgPath: "blaze.webp" },
    { type: "Witch", "action": KILL, "xp": 35, imgPath: "witch.webp" },
    { type: "Snake", "action": KILL, "xp": 120, imgPath: "snake.webp" },
    { type: "Cave Spider", "action": KILL, "xp": 15, imgPath: "cave_spider.webp" },
  ...
  "alchemist": [
    ...
    { type: "Jacaranda Log", "action": EXTRACT_FROM_SAP, "xp": 15, imgPath: "jacaranda_log.webp" },
    { type: "Blue Orchid", "action": THROW_IN_A_CAULDRON, "xp": 1, imgPath: "blue_orchid.webp" },
    { type: "Dandelion", "action": THROW_IN_A_CAULDRON, "xp": 1, imgPath: "dandelion.webp" },
    { type: "Poppy", "action": THROW_IN_A_CAULDRON, "xp": 1, imgPath: "poppy.webp" },
    { type: "White Tulip", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "white_tulip.webp" },
    { type: "Oxeye Daisy", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "oxeye_daisy.webp" },
    { type: "Orange Tulip", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "orange_tulip.webp" },
    { type: "Allium", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "allium.webp" },
    { type: "Pink Tulip", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "pink_tulip.webp" },
    { type: "Azure Bluet", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "azure_bluet.webp" },
    { type: "Red Tulip", "action": THROW_IN_A_CAULDRON, "xp": 2, imgPath: "red_tulip.webp" },
    { type: "Amethyst Ingot", "action": CRAFT_IN_PORTAL, "xp": 6, imgPath: "amethyst_ingot.webp" },
    { type: "Judeecercis Log", "action": EXTRACT_FROM_SAP, "xp": 40, imgPath: "judeecercis_log.webp" },
    { type: "Green Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 2, imgPath: "green_glueball.webp" },
    { type: "Blue Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 2, imgPath: "blue_glueball.webp" },
    { type: "Red Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 2, imgPath: "red_glueball.webp" },
    { type: "Titane Ingot", "action": CRAFT_IN_PORTAL, "xp": 20, imgPath: "titane_ingot.webp" },
    { type: "Flower Monster", "action": KILL, "xp": NaN, imgPath: "flower_monster.webp" },
    { type: "Gray Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "gray_glueball.webp" },
    { type: "Cyan Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "cyan_glueball.webp" },
    { type: "Yellow Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "yellow_glueball.webp" },
    { type: "Purple Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "purple_glueball.webp" },
    { type: "Green Dark Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "green_dark_glueball.webp" },
    { type: "Orange Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "orange_glueball.webp" },
    { type: "Green Flash Glueball", "action": CRAFT_IN_A_CAULDRON, "xp": 15, imgPath: "green_flash_glueball.webp" },
    { type: "Paladium Ingot", "action": CRAFT_IN_PORTAL, "xp": 40, imgPath: "paladium_ingot.webp" },
    { type: "Erable Log", "action": EXTRACT_FROM_SAP, "xp": 80, imgPath: "erable_log.webp" },
    { type: "Paladium Flower", "action": THROW_IN_A_CAULDRON, "xp": 100, imgPath: "flower_paladium.webp" },
  ]
}
