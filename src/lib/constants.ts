...
const how_to_xp: HowToXp = {
  "miner": [
    ...
    { type: "Deepslate", "action": BREAK, bedrock: { xp: 1 }, imgPath: "stone.webp" },
    ...
    { type: "Iron Ore", "action": BREAK, bedrock: { xp: 8, level: 10 }, imgPath: "deepslate_diamond_ore.webp" },
  ],
  "farmer": [
  ...
  "hunter": [
    ...
    { type: "Zombie", "action": KILL, java: { xp: 15, level: 7 }, imgPath: "zombie.webp" },
    { type: "Turtle", "action": KILL, java: { xp: 40, level: 8 }, bedrock: { xp: 100, level: 6 }, imgPath: "turtle.webp" },
    ...
    { type: "Bat", "action": KILL, java: { xp: 200, level: 12 }, imgPath: "bat.webp" },
  ],
  "alchemist": [
