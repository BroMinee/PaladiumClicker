...
const startSeason = new Date("2026-06-19");
...
const how_to_xp: HowToXp = {
  "miner": [
    { type: "Bottle XP", action: "Utiliser", java: { xp: 1000, excludeRequirement: true }, imgPath: "exp_miner.webp", ignorePotionBonus: true },
    { type: "Bonbon Jaune", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_YELLOW.webp" },
    { type: "Bonbon Multicolor", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_RAINBOW.webp" },
    ...
    { type: "Amethyst Ore", "action": BREAK, java: { xp: 60, level: 4 }, bedrock: { xp: 18, level: 5 }, imgPath: "amethyst_ore.webp" },
    { type: "Deepslate Emerald Ore", "action": BREAK, bedrock: { xp: 45, level: 10 }, imgPath: "deepslate_emerald_ore.webp" },
    { type: "Iron Ingot", "action": SMELT, bedrock: { xp: 2, level: 2 }, imgPath: "iron_ingot.webp" },
    ...
    { type: "Gold Ingot", "action": SMELT, bedrock: { xp: 3, level: 3 }, imgPath: "gold_ingot.webp" },
    { type: "Amethyst Ingot", "action": SMELT, bedrock: { xp: 4, level: 5 }, imgPath: "amethyst_ingot.webp" },
    { type: "Iron Particle", "action": OBTAIN_FROM_COBBLEBREAKER, java: { xp: 2, level: 5, excludeRequirement: true }, imgPath: "iron_particle.webp" },
    { type: "Gold Particle", "action": OBTAIN_FROM_COBBLEBREAKER, java: { xp: 4, level: 5, excludeRequirement: true }, imgPath: "gold_particle.webp" },
    { type: "Diamond Particle", "action": OBTAIN_FROM_COBBLEBREAKER, java: { xp: 8, level: 5, excludeRequirement: true }, imgPath: "diamond_particle.webp" },
    { type: "Amethyst Particle", "action": OBTAIN_FROM_COBBLEBREAKER, java: { xp: 12, level: 5, excludeRequirement: true }, imgPath: "amethyst_particle.webp" },
    { type: "Titane Particle", "action": OBTAIN_FROM_COBBLEBREAKER, java: { xp: 16, level: 5, excludeRequirement: true }, imgPath: "titane_particle.webp" },
    { type: "Paladium Particle", "action": OBTAIN_FROM_COBBLEBREAKER, java: { xp: 20, level: 5, excludeRequirement: true }, imgPath: "paladium_particle.webp" },
    { type: "Titane Ingot", "action": SMELT, bedrock: { xp: 50, level: 6 }, imgPath: "titane_ingot.webp" },
    ...
    { type: "Paladium Ingot", "action": SMELT, bedrock: { xp: 150, level: 8 }, imgPath: "paladium_ingot.webp" },
    ...
    { type: "Paladium Green Ingot", "action": SMELT, bedrock: { xp: 200, level: 12 }, imgPath: "paladium_green_ingot.webp" },
    ...
    { type: "Paladium Ore", "action": BREAK, java: { xp: 255, level: 8 }, bedrock: { xp: 36, level: 5 }, imgPath: "paladium_ore.webp" },
    ...
    { type: "Titane Ore", "action": BREAK, java: { xp: 85, level: 6 }, bedrock: { xp: 27, level: 5 }, imgPath: "titane_ore.webp" },
    ...
    { type: "Green Paladium Ore", "action": KILL, java: { xp: 340, level: 12 }, imgPath: "green_paladium_ore.webp" }
  ],
  "farmer": [
    { type: "Bottle XP", action: "Utiliser", java: { xp: 1000, excludeRequirement: true }, imgPath: "exp_farmer.webp", ignorePotionBonus: true },
    { type: "Bonbon Vert", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_GREEN.webp" },
    { type: "Bonbon Multicolor", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_RAINBOW.webp" },
    { type: "Bread", "action": CRAFT, java: { xp: 1, excludeRequirement: true  }, bedrock: { xp: 5, level: 4 }, imgPath: "bread.webp" },
    { type: "Wheat", "action": BREAK, bedrock: { xp: 1 }, imgPath: "wheat.webp" },
    { type: "Seed", "action": BREAK, java: { xp: 1.5 }, imgPath: "seeds_wheat.webp" },
    { type: "Baked Potato", "action": SMELT, java: { xp: 1, level: 2, excludeRequirement: true }, bedrock: { xp: 2, level: 2 }, imgPath: "potato_baked.webp" },
    ...
    { type: "Amethyst Ingot", "action": CRUSH, java: { xp: 3, level: 8, excludeRequirement: true }, imgPath: "amethyst_ingot.webp" },
    { type: "Eggplant", "action": BREAK, java: { xp: 10 , level: 8 }, bedrock: { xp: 20, level: 3 }, imgPath: "eggplant.webp" },
    { type: "Pumpkin Pie", "action": CRAFT, java: { xp: 4, level: 11, excludeRequirement: true }, bedrock: { xp: 2, level: 15 }, imgPath: "pumpkin_pie.webp" },
    { type: "Titane Ingot", "action": CRUSH, java: { xp: 4.5, level: 12, excludeRequirement: true }, imgPath: "titane_ingot.webp" },
    { type: "Chervil", "action": BREAK, java: { xp: 20, level: 12 }, bedrock: { xp: 40, level: 6 }, imgPath: "chervil.webp" },
    { type: "Paladium Ingot", "action": CRUSH, java: { xp: 6, level: 16, excludeRequirement: true }, imgPath: "paladium_ingot.webp" },
  ...
  "hunter": [
    { type: "Bottle XP", action: "Utiliser", java: { xp: 1000, excludeRequirement: true }, imgPath: "exp_hunter.webp", ignorePotionBonus: true },
    { type: "Bonbon Bleu", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_BLUE.webp" },
    { type: "Bonbon Multicolor", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_RAINBOW.webp" },
    { type: "Squid", "action": KILL, java: { xp: 10 }, imgPath: "squid.webp" },
    { type: "Cooked Porkchop", "action": SMELT, java: { xp: 10, excludeRequirement: true }, bedrock: { xp: 55, level: 4 }, imgPath: "porkchop_cooked.webp" },
    { type: "Cooked Chicken", "action": SMELT, java: { xp: 10, excludeRequirement: true }, bedrock: { xp: 50, level: 3 }, imgPath: "chicken_cooked.webp" },
    { type: "Cooked Mutton", "action": SMELT, java: { xp: 10, excludeRequirement: true }, bedrock: { xp: 45, level: 2 }, imgPath: "cooked_mutton.webp" },
    { type: "Cooked Rabbit", "action": SMELT, bedrock: { xp: 55, level: 4 }, imgPath: "cooked_rabbit.webp" },
    { type: "Steak", "action": SMELT, java: { xp: 10, excludeRequirement: true }, bedrock: { xp: 40, level: 1 }, imgPath: "steak.webp" },
    ...
    { type: "Cooked Fish", "action": SMELT, java: { xp: 15, excludeRequirement: true }, imgPath: "cooked_fish.webp" },
    { type: "Cooked Salmon", "action": SMELT, java: { xp: 15, excludeRequirement: true }, bedrock: { xp: 45, level: 2 }, imgPath: "cooked_salmon.webp" },
    ...
    { type: "Zombie", "action": KILL, bedrock: { xp: 160, level: 4 }, imgPath: "zombie.webp" },
    ...
    { type: "Skeleton", "action": KILL, bedrock: { xp: 200, level: 6 }, imgPath: "skeleton.webp" },
    { type: "Monster Spawner", "action": BREAK, java: { xp: 1250, level: 8 }, imgPath: "titane_spawner_side.webp" },
    ...
    { type: "Zombie Pigman", "action": KILL, java: { xp: 600, level: 12 }, imgPath: "zombie_pigman.webp" },
    { type: "Spider", "action": KILL, bedrock: { xp: 210, level: 8 }, imgPath: "spider.webp" },
    ...
    { type: "Ghast", "action": KILL, java: { xp: 2500, level: 15 }, imgPath: "ghast.webp" },
    { type: "Enderman", "action": KILL, java: { xp: 1500, level: 17 }, imgPath: "enderman.webp" },
    { type: "Cave Spider", "action": KILL, bedrock: { xp: 220, level: 10 }, imgPath: "cave_spider.webp" },
  ...
  "alchemist": [
    { type: "Bottle XP", action: "Utiliser", java: { xp: 1000, excludeRequirement: true }, imgPath: "exp_alchemist.webp", ignorePotionBonus: true },
    { type: "Bonbon Mauve", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_PINK.webp" },
    { type: "Bonbon Multicolor", "action": EAT, java: { xp: 50000, excludeRequirement: true }, imgPath: "candy_RAINBOW.webp" },
    { type: "Empty Flask", "action": CRAFT, java: { xp: 0.2, excludeRequirement: true }, imgPath: "empty_flask.webp" },
    ...
    { type: "Extractor", "action": CRAFT, java: { xp: 20, excludeRequirement: true }, imgPath: "extractor.webp" },
    { type: "Lightning Potion", "action": CRAFT, java: { xp: 30, excludeRequirement: true }, imgPath: "lightning_potion.webp" },
    { type: "Jacaranda Log", "action": EXTRACT_FROM_SAP, java: { xp: 60 }, imgPath: "jacaranda_log.webp" },
    { type: "Blue Orchid", "action": THROW_IN_A_CAULDRON, java: { xp: 1, level: 3, excludeRequirement: true }, imgPath: "blue_orchid.webp" },
    { type: "Dandelion", "action": THROW_IN_A_CAULDRON, java: { xp: 0.75, level: 3, excludeRequirement: true }, imgPath: "dandelion.webp" },
    { type: "Poppy", "action": THROW_IN_A_CAULDRON, java: { xp: 0.75, level: 3, excludeRequirement: true }, imgPath: "poppy.webp" },
    { type: "White Tulip", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "white_tulip.webp" },
    { type: "Oxeye Daisy", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "oxeye_daisy.webp" },
    { type: "Orange Tulip", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "orange_tulip.webp" },
    { type: "Allium", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "allium.webp" },
    { type: "Pink Tulip", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "pink_tulip.webp" },
    { type: "Azure Bluet", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "azure_bluet.webp" },
    { type: "Red Tulip", "action": THROW_IN_A_CAULDRON, java: { xp: 2, level: 3, excludeRequirement: true }, imgPath: "red_tulip.webp" },
    { type: "Amethyst Ingot", "action": CRAFT_IN_PORTAL, java: { xp: 6, level: 3, excludeRequirement: true }, imgPath: "amethyst_ingot.webp" },
    { type: "Judeecercis Log", "action": EXTRACT_FROM_SAP, java: { xp: 120, level: 5 }, imgPath: "judeecercis_log.webp" },
    { type: "Green Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 2, level: 6, excludeRequirement: true }, imgPath: "green_glueball.webp" },
    { type: "Blue Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 2, level: 6, excludeRequirement: true }, imgPath: "blue_glueball.webp" },
    { type: "Red Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 2, level: 6, excludeRequirement: true }, imgPath: "red_glueball.webp" },
    { type: "Titane Ingot", "action": CRAFT_IN_PORTAL, java: { xp: 20, level: 6, excludeRequirement: true }, imgPath: "titane_ingot.webp" },
    { type: "Flower Monster", "action": KILL, java: { xp: NaN, level: 7 }, imgPath: "flower_monster.webp" },
    { type: "Gray Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "gray_glueball.webp" },
    { type: "Cyan Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "cyan_glueball.webp" },
    { type: "Yellow Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "yellow_glueball.webp" },
    { type: "Purple Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "purple_glueball.webp" },
    { type: "Green Dark Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "green_dark_glueball.webp" },
    { type: "Orange Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "orange_glueball.webp" },
    { type: "Green Flash Glueball", "action": CRAFT_IN_A_CAULDRON, java: { xp: 15, level: 10, excludeRequirement: true }, imgPath: "green_flash_glueball.webp" },
    { type: "Paladium Ingot", "action": CRAFT_IN_PORTAL, java: { xp: 40, level: 10, excludeRequirement: true }, imgPath: "paladium_ingot.webp" },
    { type: "Erable Log", "action": EXTRACT_FROM_SAP, java: { xp: 240, level: 10 }, imgPath: "erable_log.webp" },
