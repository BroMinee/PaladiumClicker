      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 grid-rows-1 gap-4">
          <Card className="pt-6 flex flex-col items-center justify-center gap-2">
            ...
            <CardContent>
              {getIndexMetierSelected() !== -1 ?
                <MetierComponent playerInfoMetier={playerInfo.metier}
                                 increaseMetierLevel={increaseMetierLevel}
                                 decreaseMetierLevel={decreaseMetierLevel}
                                 metier={playerInfo.metier[indexMetierSelectedInPlayerInfo]}
                                 editable={false}/> : ""
              }
            </CardContent>
          </Card>
          <Card className="pt-6 flex flex-col items-center justify-center gap-2">
            ...
            <CardContent>
              {getIndexMetierSelected() !== -1 ?
                <MetierComponent playerInfoMetier={metierToReach}
                                 increaseMetierLevel={increaseMetierLevelToReach}
        ...
        {getIndexMetierSelected() !== -1 ?
          ...
          : ""}
        <HowToXp metierName={playerInfo["metier"][indexMetierSelectedInPlayerInfo]["name"]}
                 bonusXpRank={bonusXpRank}
          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-evenly">
            ...
            <div className="flex justify-center flex-row">
              <div className="space-y-2 flex justify-center flex-col">
                ...
                <Input className="w-auto" type="number" min="0" step="0.1" max="99"
                       value={Number(dailyBonus)}
                       onChange={(e) => {
