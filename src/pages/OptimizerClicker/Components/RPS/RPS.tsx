import "./RPS.css"
import { ComputePrice, computeRPS } from "@/pages/OptimizerClicker/Components/Building/BuildingList.js";
import { checkCondition } from "@/lib/misc";
import { computeXBuildingAhead, Stat } from "../Stats/Stats.jsx";
import { PlayerInfo } from "@/types/index.js";
import { usePlayerInfoStore } from "@/stores/use-player-info-store.js";
...
const RPS = ({ rps }: RPSProps) => {
  ...
  function buyUpgrade(bestListName: string, bestUpgradeIndex: number) {
      ...
      <div className={"RPS"}>
        ...
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
          <div className={"RPSValue"}>
            ...
            {rps < 0 ? <img src={import.meta.env.VITE_PUBLIC_URL + "/" + "arty_chocbar.webp"} className="App-logo"
              alt="logo" /> : ""}
          </div>
          <img src={import.meta.env.VITE_PUBLIC_URL + "/" + "coin.png"} className="App-logo" alt="logo" />
        </div>
      </div>
      <div className={"RPS"}>
        ...
        <div>
          ...
          {(buildingBuyPaths.length === 0) &&
            <div>
              <img src={import.meta.env.VITE_PUBLIC_URL + "/arty_chocbar.webp"} alt="image"
