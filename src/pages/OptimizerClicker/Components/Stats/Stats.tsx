...
import "./Stats.css";
import { getPathImg, getTotalSpend, printPricePretty } from "@/lib/misc";
import { ComputePrice, computeRPS } from "@/pages/OptimizerClicker/Components/Building/BuildingList";
...
const Stats = ({ rps }: { rps: number }) => {
  ...
  }, [check, playerInfo, prochainAchatCount, rps]);
      ...
      <div className={"RPS-father"}>
        <div className={"RPS"}>
          ...
          <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
            ...
            <div>
              <img src={`${import.meta.env.VITE_PUBLIC_URL}/coin.png`} className="App-logo"
                alt="logo" />
            </div>
          </div>
        </div>
