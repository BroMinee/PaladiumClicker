...
export default function PalatimePage() {
  ...
  const journal: MonObjet = {
    ...
    ligne18: "que je connais est la mailbox.",
    ligne19: "Soyez convainquant car lui et",
    ligne20: "ses amis seront impitoyables.",
    ligne21: "J'ai du l'espionner pour",
    ligne22: "connaitre le gagnant du tirage",
    ...
    ligne30: "qu'il lui aurai donne 1M de $.",
