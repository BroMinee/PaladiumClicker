...
export default function NotFound() {
  ...
  return (
    <Card
      className="flex flex-col gap-4 font-bold center bg-no-repeat bg-center bg-cover bg-black justify-center items-center text-white"
      style={{ height: "70vh" }}>
        ...
        <div className="py-8 px-4 mx-auto max-w-(--breakpoint-xl) lg:py-16 lg:px-6">
          <div className="mx-auto max-w-(--breakpoint-sm) text-center">
            ...
            <p className="mb-4 text-3xl tracking-tight font-bold md:text-4xl ">Désolé, cette page
              n&apos;existe
              pas.</p>
            <p className="mb-4 text-lg font-light">Si vous êtes persuadé que cette page devrait exister,
