...
test.skip("Test Body page", async ({ page }) => {
...
test.skip("Check that target-level move accordingly", async ({ page }) => {
  await page.goto("http://localhost:3000/");
...
test.skip("Check that target-level do not go under source", async ({ page }) => {
  await page.goto("http://localhost:3000/");
...
test.skip("Check increase decrease button", async ({ page }) => {
  await page.goto("http://localhost:3000/");
...
test.skip("Check that target-level move accordingly when switching jobs", async ({ page }) => {
  await page.goto("http://localhost:3000/");
...
test.skip("Check that the user can input a number that seems lower at first but is not", async ({ page }) => {
  await page.goto("http://localhost:3000/");
...
test.skip("Check current level cannot go under 0", async ({ page }) => {
  await page.goto("http://localhost:3000/");
...
test.skip("Check that level indicator is present", async ({ page }) => {
  await page.goto("http://localhost:3000/");
